function [H,vet_erro,vet_posicao,yrs]=criarMatrizH(erro_geral, erro_medio_amostra,erro_medio_geral, imagem,set_num_amostrados,E)
...
yrs = reconstruir_face(E,H,imagem);
vetor = [imagem, H, yrs];
ver_projecao(vetor);
end